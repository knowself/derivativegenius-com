...
This repository is more than the source code for a company website. It is the working foundation of Derivative Genius.

It contains five connected systems:

1. **The public promise** — the website through which people understand the company, evaluate its work, and begin a relationship.
...
`/centurion` is Joe Terry's private operating instrument.

It exists to strengthen discipline, memory, and follow-through. It helps the Centurion:

- define a narrow market;
- preserve the source of prospect information;
- distinguish qualified opportunities from noise;
- record specific website observations;
- prioritize the next safe and valuable action;
- place calls manually;
- record outcomes and commitments;
- honor suppressions and opt-outs;
- prepare useful audits after interest is established;
- advance legitimate opportunities; and
...
Joe Terry, the human Centurion
    -> sets purpose and exercises judgment
        -> uses /centurion to organize action and memory
...
Every engagement should connect technical work to a human or commercial outcome. A feature without a meaningful outcome is not progress.
...
Do not present aspiration as achievement. Performance, accessibility, revenue, conversion, security, and client-result claims require evidence or careful qualification.
...
Automate a repeated, measured bottleneck only after the underlying work is understood. More volume is not automatically more value.

### 5. Plain language before jargon

Explain what the system does for a person or business before explaining how it is engineered.

### 6. Persistence before notification

Protect the primary record and the user's work before relying on secondary messages or external services.
...
Complete promised follow-ups before generating more leads, features, or tasks.
...
This is the mission at its smallest useful scale: one person, one instrument, 25 companies, honest conversations, disciplined records, and a real attempt to create value.
...
4. Does it improve a meaningful outcome?
...
- the business earns revenue by delivering genuine value; and
...
>
> I will build on the work of those who came before us and leave behind systems, knowledge, and opportunities that allow others to stand higher.
>
