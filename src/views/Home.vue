<template>
  <div class="home-container">
    <!-- Quote Section -->
    <div class="py-8 bg-white dark:bg-gray-800 relative overflow-hidden animate-on-scroll">
        ...
        <div class="text-center">
          <div class="relative">
            <img 
              ...
              class="mx-auto mb-12 rounded-2xl shadow-2xl max-w-3xl w-full animate-fade-in-up"
            >
          </div>
        </div>
      </div>
    ...
    <!-- Hero Section -->
    <div class="relative min-h-screen overflow-hidden bg-gradient-to-br from-gray-900 via-indigo-900 to-purple-900 dark:from-gray-800 dark:via-indigo-800 dark:to-purple-800 animate-on-scroll">
            ...
            <div class="text-center lg:text-left flex flex-col lg:flex-row items-center justify-between">
              <div class="lg:w-1/2">
                <h1 class="text-4xl tracking-tight font-extrabold text-white sm:text-5xl md:text-6xl">
                  ...
                  <span class="block bg-clip-text text-transparent bg-gradient-to-r from-yellow-400 to-yellow-200 dark:from-yellow-300 dark:to-yellow-100 animate-fade-in-up-delay">
                    Your Business with AI
                  </span>
                </h1>
                <p class="mt-3 text-base text-gray-300 dark:text-gray-200 sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-5 md:text-xl lg:mx-0 animate-fade-in-up-delay-2">
    ...
    <!-- Services Section -->
    <div class="bg-white dark:bg-gray-800 py-24 sm:py-32 animate-on-scroll">
      <div class="mx-auto max-w-7xl px-6 lg:px-8">
        <div class="mx-auto max-w-2xl text-center">
          <h2 class="text-3xl font-bold tracking-tight text-gray-900 dark:text-white sm:text-4xl">Transform Your Business with AI</h2>
          ...
          <dl class="grid max-w-xl grid-cols-1 gap-x-8 gap-y-16 lg:max-w-none lg:grid-cols-3">
            <div class="flex flex-col transform hover:scale-105 transition-all duration-300 hover-lift">
              ...
              <dd class="mt-1 flex flex-auto flex-col text-base leading-7 text-gray-600 dark:text-gray-300">
                ...
                <p class="mt-6">
                  <a href="#contact" class="text-sm font-semibold leading-6 text-indigo-600 dark:text-indigo-400">Learn more <span aria-hidden="true">→</span></a>
                </p>
              </dd>
            </div>
            <div class="flex flex-col transform hover:scale-105 transition-all duration-300 hover-lift">
    ...
    <!-- Articles Section -->
    <div id="articles" class="py-12 bg-gray-50 dark:bg-gray-900 animate-on-scroll">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="lg:text-center">
          <h2 class="text-base text-indigo-600 dark:text-indigo-400 font-semibold tracking-wide uppercase">Resources</h2>
    ...
    <!-- Contact Section -->
    <div id="contact" class="py-12 bg-white dark:bg-gray-800 animate-on-scroll">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="lg:text-center">
          <h2 class="text-base text-indigo-600 dark:text-indigo-400 font-semibold tracking-wide uppercase">Contact Us</h2>
          <p class="mt-2 text-3xl leading-8 font-extrabold tracking-tight text-gray-900 dark:text-white sm:text-4xl">
...
onMounted(() => {
  // Ensure all content is loaded before showing
