    ...
    <div className="rounded-2xl border border-emerald-500/30 bg-slate-900/80 p-8 sm:p-12 backdrop-blur-xl space-y-10">
      ...
      <div className="grid grid-cols-1 gap-8 md:grid-cols-2">
        <Card className="flex flex-col justify-between border-emerald-500/20">
          ...
          <CardContent className="space-y-4">
            <div className="rounded-xl border border-slate-800 bg-slate-950/70 p-4 text-sm text-slate-300 space-y-2">
              <div className="text-xs font-semibold uppercase tracking-wider text-slate-400">Shot list (no asset yet — do not ship a stock stand-in)</div>
            ...
            <div className="flex flex-wrap gap-3">
              <a
                ...
                className="inline-flex items-center space-x-2 rounded-xl bg-emerald-600 px-5 py-3 text-sm font-semibold text-white hover:bg-emerald-500"
              >
              ...
              <Link
                href="/contact"
                className="inline-flex items-center space-x-1.5 rounded-xl border border-slate-700 bg-slate-900 px-5 py-3 text-sm font-semibold text-slate-200 hover:border-slate-600 hover:bg-slate-800"
              >
        ...
        <Card className="flex flex-col justify-between border-emerald-500/20">
          ...
          <CardContent className="space-y-4">
            <div className="rounded-xl border border-slate-800 bg-slate-950/70 p-4 text-sm text-slate-300 space-y-2">
              <div className="text-xs font-semibold uppercase tracking-wider text-slate-400">Timing (Mike Stewart 15s frame)</div>
              <ul className="space-y-1">
                <li><span className="font-semibold text-slate-200">0–5s anchor:</span> [SERP term + town — TBD per client]</li>
                <li><span className="font-semibold text-slate-200">5–12s benefit:</span> [one problem solved — TBD per client]</li>
                <li><span className="font-semibold text-slate-200">12–15s nudge:</span> [call now — phone anchor]</li>
              </ul>
            </div>
            <Link
              href="/contact"
