  ...
  return (
    <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8 space-y-16">
      <div className="max-w-4xl space-y-5">
        <div className="inline-flex items-center rounded-full border border-blue-200 bg-blue-100 dark:border-blue-500/30 dark:bg-blue-500/10 px-4 py-1.5 text-xs font-semibold uppercase tracking-[0.2em] text-blue-700 dark:text-blue-400">
        ...
        <div className="mt-6 flex flex-col sm:flex-row items-center sm:items-start gap-6">
          <img
            src={AUTHOR_IMAGE}
            alt={AUTHOR_NAME}
            className="h-44 w-44 sm:h-52 sm:w-52 rounded-full object-cover border border-slate-300 dark:border-slate-700 bg-slate-100 dark:bg-slate-800 shadow-md shrink-0"
          />
          <div>
            <h3 className="text-xl font-semibold text-slate-900 dark:text-white">{AUTHOR_NAME}</h3>
            <p className="mt-2 text-slate-600 dark:text-slate-300 leading-relaxed max-w-2xl">{AUTHOR_MESSAGE}</p>
          </div>
        </div>
      </div>
      ...
      <div className="rounded-2xl border border-slate-200 bg-white dark:border-slate-800 dark:bg-slate-900/60 p-8 sm:p-12 space-y-6 shadow-sm">
        ...
        <div>
          <Link
            href="/contact"
            className="inline-flex items-center space-x-2 rounded-xl bg-blue-600 px-6 py-3 font-semibold text-white hover:bg-blue-500 shadow-md transition active:scale-95"
          >
